...
if (isset($_POST['addProduct'])) {
  ...
  if (empty($_POST["kode_menu"]) || empty($_POST["nama_menu"]) || empty($_POST['deskripsi_menu']) || empty($_POST['harga_menu'])) {
    ...
    move_uploaded_file($_FILES["gambar_menu"]["tmp_name"], "../admin/assets/img/menu/" . $_FILES["gambar_menu"]["name"]);
          ...
          <div class="card shadow">
            ...
            <div class="card-body">
              <form method="POST" enctype="multipart/form-data">
                ...
                <div class="form-row">
                  <div class="col-md-6">
                    <input type="submit" name="addProduct" value="TTambah Menu" class="btn btn-success" value="">
                  </div>
                </div>
              </form>
            </div>
