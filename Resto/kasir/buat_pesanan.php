...
if (isset($_POST['make'])) {
  ...
  if (empty($_POST["kode_pesanan"]) || empty($_POST["nama_user"]) || empty($_GET['harga_menu'])) {
    ...
    //bind paramaters
    $rc = $postStmt->bind_param('ssssssss', $jumlah_menu, $id_pesanan, $kode_pesanan, $id_users, $nama_user, $id_menu, $nama_menu, $harga_menu);
    $postStmt->execute();
              ...
              <form method="POST" enctype="multipart/form-data">
                <div class="form-row">
                  ...
                  <div class="col-md-4">
                    ...
                    <select class="form-control" name="nama_user" id="custName" onChange="getCustomer(this.value)">
                      ...
                      ?>
                        <option><?php echo $cust->nama_user; ?></option>
                      <?php } ?>
                    </select>
                  ...
                  <div class="col-md-4">
                    ...
                    <input type="text" name="id_users" readonly id="customerID" class="form-control">
                  </div>
