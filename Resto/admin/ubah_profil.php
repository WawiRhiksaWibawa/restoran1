...
if (isset($_POST['ChangeProfile'])) {
  ...
  if ($postStmt) {
    $success = "Akun Diperbarui" && header("refresh:1; url=dasbor_admin.php");
  } else {
...
if (isset($_POST['changePassword'])) {
  ...
  if (isset($_POST['confirm_password']) && !empty($_POST['confirm_password'])) {
    ...
    $error = 1;
    $err = "Konfirmasi Password Tidak Boleh Kosong";
  }
  ...
  if (!$error) {
    ...
    if (mysqli_num_rows($res) > 0) {
      ...
      if ($old_password != $row['password']) {
        ...
        //declare a varible which will be passed to alert function
        if ($stmt) {
          $success = "Password Terubah" && header("refresh:1; url=dasbor_admin.php");
        } else {
          $err = "Silakan Coba Lagi Atau Coba Nanti";
        }
      }
